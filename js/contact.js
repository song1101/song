window.onload=function(){
    ...
    if(document.getElementById("contact")!=null){
        document.getElementById("contact").onsubmit=function () {
            ...
            document.getElementById("submitmessage").innerHTML="<strong> 姓名:"+sName+"<br>性别:"+sSex+"<br>年龄范围:"+sAge
            +"<br>爱好:"+sInterest+"<br>电子邮件:"+sDzyj+"<br>固定电话:"+sTelephone+"<br>公司:"+sCompany+"</strong>";
           return false;
            /*return true;//提交表单*/
        }
    }
